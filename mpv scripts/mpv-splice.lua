...
local default_tmp_location = "D:\\spliced\\tmp"
local default_output_location = 'D:\\spliced'

--------------------------------------------------------------------------------

local splice_options = {
	tmp_location = default_tmp_location,
...
function process_video()
	...
	if times[#times] then
		local tmp_dir = splice_options.tmp_location .. RandomVariable(6)
		...
		notify(10000,"Process ended!")

		os.execute(string.format("rmdir %s /s /q", tmp_dir))
