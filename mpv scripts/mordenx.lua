...
local user_opts = {
    ...
    minmousemove = 5, -- minimum amount of pixels the mouse has to
    ...
    title = '${filename} - (${media-title})', -- string compatible with property-expansion
...
function process_event(source, what)
    ...
    if what == 'down' or what == 'press' then
        ...
        if source == 'wheel_up' then -- mouse button down
